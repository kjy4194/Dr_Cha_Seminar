...
2. Claude Code 설치: ✅ 완료 (claude --version: 2.1.20)
3. Git 설치: ✅ 완료 (버전: 2.51.1.windows.1)
4. GitHub 저장소 생성 및 업로드: ✅ 완료
5. Node.js 설치: ✅ 완료 (버전: 22.21.0)
6. Python 설치: ✅ 완료 (버전: 3.11.8)

■ GitHub 저장소 URL:
https://github.com/kjy4194/Dr_Cha_Seminar
■ 어려웠던 점 또는 질문사항:
(기계연내 PC에서는 claude설치가 안되어
테더링하여 개인 노트북으로 작업함.
전자통연이나 원자력연은 테더링도 안된다던데
그나마 다행임. 혹시 연구소내에서 Claude설치방법이 있음면 알려주시면 감사하겠니다.)
